...
document.querySelectorAll('script').forEach(function(s){
	if(s.src.match(/play-project\/players\//)) {
		...
		s.remove();
		//document.querySelector('#appJs').src = "https://awesome-e.github.io/hs-tools/play-project/application.js";
	}
});
