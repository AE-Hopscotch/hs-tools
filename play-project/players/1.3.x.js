...
!function(e) {
    ...
    var h = function() {
        ...
        return e.prototype.findAllForClassName = function(e) {
            ...
            for (var e = this.findAllForClassName(f.HSParameter.key), t = [], u = 0; u < e.length; u++) {
                var r = e[u];
                r.type === s.HSParameterType.Sound && -1 === t.indexOf(r.value) && t.push(r.value);
            }
            return t;
        ...
        return e.prototype.newWithNewBlocksToExecuteLater = function(t) {
            ...
            switch (e.type) {
              ...
              case o.HSBlockType.PlaySound:
                var r = n.HSSoundManager.sharedInstance, f = u[0].computedStringValue(t);
                r.play(f);
                break;
    ...
    var r = u(1), i = function() {
        ...
        return e.prototype.play = function() {
            ...
            return "hopscotch-sounds/" /*AE_MOD Self-host sounds  "https://d2jeqdlsh5ay24.cloudfront.net/"*/ + this.name + ".mp3";
