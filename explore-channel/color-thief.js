!function(t, r) {
    ...
    var r = function() {
        ...
        return u.prototype = {
            ...
            avg: function(t) {
                ...
                if (!this._avg || t) {
                    ...
                    for (i = this.r1; i <= this.r2; i++) for (u = this.g1; u <= this.g2; u++) for (a = this.b1; a <= this.b2; a++) s += o = n[e(i, u, a)] || 0, 
                    c += o * (i + .5) * h, f += o * (u + .5) * h, v += o * (a + .5) * h;
            ...
            palette: function(imgSize) {
                return this.vboxes.map(function(t) {
					//AE-mod
					return t.color.concat([Math.round(t.vbox._count/imgSize*100000)/100000]);
					return t.color;
                });
            },
            size: function() {
            ...
            nearest: function(t) {
                for (var r, n, o, e = this.vboxes, i = 0; i < e.size(); i++) ((n = Math.sqrt(Math.pow(t[0] - e.peek(i).color[0], 2) + Math.pow(t[1] - e.peek(i).color[1], 2) + Math.pow(t[2] - e.peek(i).color[2], 2))) < r || void 0 === r) && (r = n, 
                o = e.peek(i).color);
                return o;
            },
            forcebw: function() {
            ...
            quantize: function(h, c) {
                ...
                var v = function(t, r) {
                    ...
                    return t.forEach(function(t) {
                        (o = t[0] >> n) < a ? a = o : o > s && (s = o), (e = t[1] >> n) < h ? h = e : e > c && (c = e), 
        ...
        this.width = this.canvas.width = t.width, this.height = this.canvas.height = t.height, 
    ...
    return o.prototype.getColor = function(t, r) {
        ...
        var i = function(t) {
            ...
            colorCount: o,
            quality: e
        }), u = new n(t), a = function(t, r, n) {
            for (var o = t, e = [], i = 0, u = void 0, a = void 0, s = void 0, h = void 0, c = void 0; i < r; i += n) a = o[0 + (u = 4 * i)], 
            s = o[u + 1], h = o[u + 2], (void 0 === (c = o[u + 3]) || c >= 125) && (/*a > 250 && s > 250 && h > 250 || */e.push([ a, s, h ]));
			return e;
        }(u.getImageData().data, u.width * u.height, i.quality), s = r(a, i.colorCount);
		//AE-mod
		return s ? s.palette(u.width * u.height / i.quality) : null;
