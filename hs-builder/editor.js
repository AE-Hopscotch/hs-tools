	...
	var checkAbility = {
		...
		secretBlocks: function(a) {
			...
			const	cmtVarCond = {"type":45,"parameters":[{"type": -1},{"datum":"{\"block_class\":\"conditionalOperator\",\"type\":10[0-1][0-9],[^\\{\\}\\[\\]]*?\"params\":\\[\\{[^\\{\\}\\[\\]]*?\"datum\":\\{[^\\{\\}\\[\\]]*?\"type\":22,[^\\{\\}\\[\\]]*?\"params\":\\[\\{[^\\{\\}\\[\\]]*?(\"value\":\".*?\")?[^\\{\\}\\[\\]]*?\\}\\]\\},[^\\{\\}\\[\\]]*?\"type\":[0-9]{1,3}\\},\\{[^\\{\\}\\[\\]]*?\"type\":[0-9]{1,3}[^\\{\\}\\[\\]]*?\\}\\]}","type":"^49$"}]},
					cdtVarCond = {"type":44,"parameters":[{"type": -1},{"datum":"({\"block_class\":\"conditionalOperator\",\"type\":10[0-1][0-9],[^\\{\\}\\[\\]]*?\"params\":\\[)(\\{.*?\"type\":4000[^\\{\\}\\[\\]]*?\"params\":\\[\\{[^\\{\\}\\[\\]]*?\"datum\":\\{[^\\{\\}\\[\\]]*?\"type\":22[^\\{\\}\\[\\]]*?\"params\":\\[\\{[^\\{\\}\\[\\]]*?(\"value\":\".*?)?[^\\{\\}\\[\\]]*?\"type\":[0-9]{1,3}\\}[^\\{\\}\\[\\]]*?\\]\\},[^\\{\\}\\[\\]]*?\"type\":[0-9]{1,3}\\}(,\\{.*?\\})\\]\\}[^\\{\\}\\[\\]]*?\"type\":[0-9]{1,3}\\},?)(\\{.*?\"type\":4000[^\\{\\}\\[\\]]*?\"params\":\\[\\{[^\\{\\}\\[\\]]*?\"datum\":\\{[^\\{\\}\\[\\]]*?\"type\":22[^\\{\\}\\[\\]]*?\"params\":\\[(\\{[^\\{\\}\\[\\]]*?(\"value\":\".*?)?[^\\{\\}\\[\\]]*?\"type\":[0-9]{1,3}\\},?){2}(,\\{.*?\\})\\]\\})(.*?\"type\":[0-9]{1,3},?\\}(,\\{*?\\})?\\]\\})","type":"^49$"}]},
					inputDeflt = {"type":63,"parameters":[{"type": "^47$"},{"type":"^53$"},{"type":"^53$"}]},
					...
					commentBlk = {"type":22,"parameters":[{"type": -1}]},
					cDataBlock = {"type":22,"parameters":[{"type": -1},{"key":"^data$","type":"^53$"}]},
			...
			var		hasNewest = (isSecretBlocks && checkAbility.checkScript(blocks,[cmtVarCond,cdtVarCond,inputDeflt,multByCond,sceneTextB,hiddenAbil,setOpacity,commentBlk,cDataBlock,ImgFreezeB/*,reqSeedsBl*/]))
...
if (editor.modulesScripts) {
	...
	document.querySelectorAll('.keyboard-system-ctrl-key').forEach(e=>e.innerHTML=(onIos||navigator.userAgent.match(/Mac/))?'&#x2318;':'ctrl');
}
