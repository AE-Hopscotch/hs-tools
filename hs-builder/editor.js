...
if (editor.useBlockRender) {
	...
	function replaceRender(data, tct, desc) {
		...
		document.getElementById("blocks-container-resizer").innerHTML = '<div class="drag-handle"><span label="blockrender">Block Rendering: ' + desc + (desc!="Entire Project"&&tct?' <a title="See Entire Project" href="javascript:void(0)" onclick="replaceRender(-1)">&ic; <i class="fa fa-list-alt"></i></a>':'')+' <a class="refresh-btn" title="Refresh Project" href="javascript:void(0)" onclick="editor.blockrender.refresh()">&ic; <i class="fa fa-refresh"></i></a></span><span hidden label="renderjson">JSON Project Render</span></a><a title="Toggle Code Viewing" style="position:absolute;top:3px;right:30px;" href="javascript:void(0)" onclick="editor.display.renderjson()"><i class="fa fa-code"></i></a><a title="Run the Project" style="position:absolute;top:3.5px;right:6px;" href="javascript:void(0)" onclick="editor.project.play()"><i class="fa fa-play"></i></a></div><div id="blocks-container" class="bl-container" style="padding: 36px 8px;" data-group="'+tct+'"></div><div hidden id="renderjson-container"></div><div class="resizer"></div>';
...
if (editor.logConsoleMesg){
	...
	console.log('%cHopscotch Project Builder, beta 1.0.0 %c \u2063 Made by Awesome_E ¯\\_(ツ)_/¯','display:block; padding: 4px 6px; border: 4px solid red; background-color: salmon; color: white; font-weight: bold;','');
}
