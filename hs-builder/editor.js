...
if (editor.logConsoleMesg){
	...
	console.log('%cHopscotch Project Builder, beta 1.1.0 r1 %c \u2063 Made by Awesome_E ¯\\_(ツ)_/¯','display:block; padding: 4px 6px; border: 4px solid red; background-color: salmon; color: white; font-weight: bold;','');
}